...
for (source_file in source_files) {
  source(paste0("./ext_exp/", source_file))
...
population <- pt_population_norte / 100
start_inf <- 4
hospcap <- pt_hospcap
...
plot_ly_sir(teste1, c("e.num", "i.num", "q.num", "h.num", "f.num", "r.num"), events = events) %>% add_annotations(
  x = 1,
  y = 1,
  xref = "paper",
  yref = "paper",
...
plot_ly_sir(teste2, c("e.num", "i.num", "q.num", "h.num", "f.num", "r.num"), events = events) %>% add_annotations(
  x = 1,
  y = 1,
  xref = "paper",
  yref = "paper",
...
plot_ly_sir(teste, c("f.num", "h.num", "i.num", "q.num", "e.num", "r.num"), stacked = TRUE, grouped = TRUE, real_data = geo_norte, events = events, log = TRUE) %>% add_annotations(
  x = 1,
  y = 1,
  xref = "paper",
  yref = "paper",
...
plot_ly_sir(teste2, c("f.num", "h.num", "i.num", "q.num", "e.num", "r.num"), stacked = TRUE, grouped = TRUE, real_data = geo_norte, events = events, log = TRUE) %>% add_annotations(
  x = 1,
  y = 1,
  xref = "paper",
  yref = "paper",
