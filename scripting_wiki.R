...
write.csv(covid_south_korea, "covid_south_korea_long.csv", row.names = FALSE)
write.csv(sk_df1, "covid_south_korea_wide.csv", row.names = FALSE)
write.csv(sk_prov_map, "sk_city_prov_mapping.csv", row.names = FALSE)
...
italy_region_mapping <- data.frame(
  region = c(
...
italy_names <- c(
  "Date", "VDA", "LIG", "PIE", "LOM", "VEN", "TN", "BZ",
  "FVG", "EMR", "MAR", "TOS", "UMB", "LAZ", "ABR", "MOL",
  "CAM", "BAS", "PUG", "CAL", "SIC", "SAR",
...
italy4 <- italy3 %>%
  dplyr::filter(sub_region %in% italy_totals) %>%
...
write.csv(covid_italy, "covid_italy_long.csv", row.names = FALSE)
write.csv(italy2, "covid_italy_wide.csv", row.names = FALSE)
write.csv(italy_region_mapping, "italy_region_mapping.csv", row.names = FALSE)
